export const erc20ABI = ["function decimals() public view returns (uint8)"]
...
export const factoryABI = ["function getPair(address tokenA, address tokenB) external view returns (address pair)"]
